...
" Transparency: set `let g:kronuz_transparent = 1` before `:colorscheme kronuz`
" to drop the editor + gutter backgrounds and inherit your terminal background.
if get(g:, "kronuz_transparent", 0)
