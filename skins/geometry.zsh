...
KZ_PROMPT_RPROMPT='${kz[git.branch]:+${kz[git.ahead]:+⇡ }${kz[git.behind]:+⇣ }${kz[FG.geometry_branch]}${kz[git.branch]}${kz[RESET]} ${kz[git.stashed]:+${kz[FG.geometry_stash]}●${kz[RESET]} }${kz[git.dirty]:+${kz[FG.red]}⬡${kz[RESET]}}}'
