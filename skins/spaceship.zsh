...
KZ_PROMPT_PROMPT='${kz[FG.cyan]}➜ ${kz[FG.green]}%~${kz[RESET]}$kz[git]${kz[venv.name]:+ ${kz[FG.yellow]}via ${kz[venv.name]}${kz[RESET]}}$kz[nl]%(?.${kz[FG.green]}.%F{red})❯ '
KZ_PROMPT_RPROMPT=''
KZ_PROMPT_TRANSIENT_PROMPT='${kz[FG.green]}%~${kz[RESET]} %(?.${kz[FG.green]}.%F{red})❯ '
