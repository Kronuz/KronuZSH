...
KZ_PROMPT_PREPROMPT='${${kz[status.exit]:#0}:+${kz[FG.red]}FAIL${kz[RESET]}$kz[NL]} '
KZ_PROMPT_PROMPT='${kz[FG.magenta]}%n${kz[RESET]}@${kz[FG.yellow]}%m${kz[RESET]}: ${kz[BOLD]}${kz[FG.blue]}%~${kz[RESET]}$kz[git]$kz[NL]%(!.${kz[FG.red]}#${kz[RESET]}.$) '
