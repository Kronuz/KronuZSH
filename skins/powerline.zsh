...
PROMPT_KRONUZ_PROMPT='${bcol[gray]}${fcol[white]} %n@%m ${fcol[darkgrey]}${bcol[blue]}'$'\ue0b0''${fcol[white]} %~ $kronuz[git]%k${${_prompt_kronuz_git_branch:+${fcol[green]}}:-${fcol[blue]}}'$'\ue0b0''%f '
PROMPT_KRONUZ_RPROMPT=''
PROMPT_KRONUZ_TRANSIENT_PROMPT='${bcol[blue]}${fcol[white]} %~ %k${fcol[blue]}'$'\ue0b0''%f '
