...
KZ_PROMPT_GIT='${kz[git.branch]:+${kz[BG.green]}${kz[FG.blue]}'$'\ue0b0''${kz[FG.gray]} '$'\ue0a0'' ${kz[git.branch]} }'
KZ_PROMPT_PROMPT='${kz[BG.gray]}${kz[FG.white]} %n@%m ${kz[FG.darkgrey]}${kz[BG.blue]}'$'\ue0b0''${kz[FG.white]} %~ $kz[git]%k${${kz[git.branch]:+${kz[FG.green]}}:-${kz[FG.blue]}}'$'\ue0b0''%f '
KZ_PROMPT_RPROMPT=''
KZ_PROMPT_TRANSIENT_PROMPT='${kz[BG.blue]}${kz[FG.white]} %~ %k${kz[FG.blue]}'$'\ue0b0''%f '
