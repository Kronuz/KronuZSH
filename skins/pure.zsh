...
KZ_PROMPT_STATUS=0
KZ_PROMPT_PROMPT='%(1j.${kz[FG.red]}✦${kz[RESET]} .)${kz[context.ssh]:+${kz[FG.pure_gray]}%n@%m${kz[RESET]} }${kz[FG.blue]}%~${kz[RESET]}$kz[git]${_kz_prompt_duration:+ ${kz[FG.yellow]}${_kz_prompt_duration}${kz[RESET]}}$kz[nl]${VIRTUAL_ENV:+${kz[FG.pure_gray]}${VIRTUAL_ENV:t}${kz[RESET]} }%(?.${kz[FG.magenta]}.${kz[FG.red]})❯${kz[RESET]} '
KZ_PROMPT_RPROMPT=''
