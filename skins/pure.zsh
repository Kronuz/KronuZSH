...
KZ_PROMPT_PREPROMPT=''
KZ_PROMPT_PROMPT='%(1j.${kz[FG.red]}✦${kz[RESET]} .)${kz[context.ssh]:+${kz[FG.pure_gray]}%n@%m${kz[RESET]} }${kz[FG.blue]}%~${kz[RESET]}$kz[git]${kz[status.duration]:+ ${kz[FG.yellow]}${kz[status.duration]}${kz[RESET]}}$kz[NL]${VIRTUAL_ENV:+${kz[FG.pure_gray]}${VIRTUAL_ENV:t}${kz[RESET]} }%(?.${kz[FG.magenta]}.${kz[FG.red]})❯${kz[RESET]} '
KZ_PROMPT_RPROMPT=''
