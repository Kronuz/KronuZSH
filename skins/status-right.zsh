...
#   1. KZ_PROMPT_PREPROMPT='' turns off the default behaviour of printing the status on its own
...
# Collapsed scrollback line: submission time, path, then the past caret (the status is
# gone by now).
