...
# command that doubles as the exit-status signal: dark gray normally, red when the last
...
#   ${${kz[status]:+RED}:-DARKGRAY}  red when there is a status, dark gray otherwise
