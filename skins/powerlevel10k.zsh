...
KZ_PROMPT_PROMPT='${kz[FG.blue]}%~${kz[RESET]}$kz[git]$kz[NL]${kz[FG.green]}${kz[GLYPH.caret]}${kz[RESET]} '
KZ_PROMPT_RPROMPT='${kz[venv.name]:+${kz[FG.green]}(${kz[venv.name]})${kz[RESET]} }%*'
KZ_PROMPT_TRANSIENT_PROMPT='${kz[FG.blue]}%~${kz[RESET]} ${kz[FG.green]}${kz[GLYPH.caret]}${kz[RESET]} '
