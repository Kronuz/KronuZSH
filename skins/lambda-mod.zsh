...
KZ_PROMPT_GIT='${kz[git.branch]:+ at ${kz[FG.blue]} ${kz[git.branch]}${kz[RESET]}${kz[git.dirty]:+ ${kz[git.staged]:+${kz[BOLD]}${kz[FG.green]}+}${kz[git.unstaged]:+${kz[BOLD]}${kz[FG.blue]}!}${kz[git.conflicted]:+${kz[BOLD]}${kz[FG.yellow]}#}${kz[git.untracked]:+${kz[BOLD]}${kz[FG.cyan]}?}${kz[RESET]}}}'
KZ_PROMPT_STATUS=0
